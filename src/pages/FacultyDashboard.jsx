...
function FacultyDashboard() {
  ...
  (item.roll && item.roll.toLowerCase().includes(searchTerm.toLowerCase())) ||
  ...
  (item.experiences && item.experiences.toLowerCase().includes(searchTerm.toLowerCase())) ||
  ...
  (item.semesterResult && item.semesterResult.toLowerCase().includes(searchTerm.toLowerCase())) ||
  (item.internships && item.internships.toLowerCase().includes(searchTerm.toLowerCase())) ||
  (item.hobbies && item.hobbies.toLowerCase().includes(searchTerm.toLowerCase()))
);
        ...
        <ul className="nav nav-tabs justify-content-between">
          ...
          <div className="dropdown">
            <li className="nav-item dropdown userAction">
              <a
                className="nav-link dropdown-toggle userAction"
                role="button"
